package com.mdove.android.uilib.tablayout;
...
import com.mdove.android.uilib.BuildConfig;
import com.mdove.android.uilib.R;
import com.mdove.android.uilib.interpolator.SmartTabIndicationInterpolator;
import com.mdove.android.uilib.tablayout.listener.OnTabSelectListener;
import com.mdove.android.uilib.tablayout.utils.UnreadMsgUtils;
import com.mdove.android.uilib.tablayout.widget.MDoveFeedTabView;
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private static final int DIRECTION_IDEL = 0;
...
//                throw new IllegalStateException("Titles can not be EMPTY !");
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = childCount; i < mTabCount; i++) {
            MDoveFeedTabView tabView = new MDoveFeedTabView(mContext);
    ...
    private void addTab(final int position, String title, View tabView) {
        ...
        float tabWidth = UIUtils.dip2Px(getContext(), 84);
        float titleWidth = paint.measureText(title);
        if (tabWidth < titleWidth) {
            mTextsize = UIUtils.dip2Px(getContext(), 14);
        }
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    public void showMsg(int position, int num) {
        ...
        if (tipView != null) {
            UnreadMsgUtils.show(tipView, num,false);
            if(num>0) {
    ...
    public void setMsgMargin(int position, float leftMargin, float topMargin) {
        ...
        if (tipView != null) {
            ...
            lp.leftMargin = getTabWidth() >= 0 ? (int) (getTabWidth() / 2 + textWidth / 2 + dp2px(leftMargin)) : (int) (mTabPadding + textWidth + dp2px(leftMargin));
