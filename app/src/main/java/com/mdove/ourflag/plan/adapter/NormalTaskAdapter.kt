 ...
 */
class NormalTaskAdapter(clickTopOption: () -> Unit, itemClick: (taskBean:NormalTaskItemBean) -> Unit) : MultiTypeAdapter() {
    private val addTaskItemBinder = AddTaskItemBinder(clickTopOption)
    private val normalTaskItemBinder = NormalTaskItemBinder(itemClick)
