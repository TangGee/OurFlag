 ...
 */
class NormalTaskItemBinder(val click: (taskBean: NormalTaskItemBean) -> Unit) : ItemViewBinder<NormalTaskItemBean, NormalTaskItemViewHolder>() {
    override fun onBindViewHolder(viewHolderTask: NormalTaskItemViewHolder, data: NormalTaskItemBean) {
        viewHolderTask.bindData(data)
    }

    override fun onCreateViewHolder(inflater: LayoutInflater, parent: ViewGroup): NormalTaskItemViewHolder {
        return NormalTaskItemViewHolder(inflater, parent, click)
    }
}

class NormalTaskItemViewHolder(inflater: LayoutInflater, parent: ViewGroup, val click: (taskBean: NormalTaskItemBean) -> Unit) : RecyclerView.ViewHolder(
        inflater.inflate(R.layout.item_normal_task, parent, false)) {
